...
public class MultiActivity extends AbstractActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    toolbarTitle.setText(getResources().getString(R.string.multi_renderers));
    ViewUtil.configMultiRecyclerView(this, recyclerView);
  }
